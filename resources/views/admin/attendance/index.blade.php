...
<div class="page-header">
    <div>
        ...
        <p style="color: #64748b;">Viewing records for: <strong>{{ \Carbon\Carbon::parse($selectedDate)->format('d M Y') }}</strong></p>
    </div>
    ...
    <form action="{{ route('admin.attendance.index') }}" method="GET" class="filter-form">
        ...
        <a href="{{ route('admin.attendance.index') }}" class="btn-reset">Today</a>
    </form>
</div>
